...
public class DecryptFile implements Constants {
	...
	public static void main(String[] args) throws Exception {
		...
		SecretKey clave_pbe = SecretKeyFactory.getInstance("PBEWITHSHA1ANDRC2_40").generateSecret(clave_pbe_spec);
		PBEParameterSpec param_pbe_spec = new PBEParameterSpec(buffer, ITERACIONES_PBE);
		Cipher descifrador_pbe = Cipher.getInstance("PBEWITHSHA1ANDRC2_40");
